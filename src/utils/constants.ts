...
export const ONE_HOUR_IN_SECONDS = BigInt.fromI32(3600);
export const ONE_DAY_IN_SECONDS = BigInt.fromI32(86400);
export const ONE_WEEK_IN_SECONDS = BigInt.fromI32(7).times(ONE_DAY_IN_SECONDS);
